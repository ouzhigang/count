...
class Ip
{
    ...
    public function getLocation($ip = '')
    {
        ...
        if (!isset($locationData[$ip])) {
			...
			$location['country'] = "中国";
			if($location['state'] == "未知" && $location['city'] == "未知" && $location['area'] == "未知") {
				$location['country'] = $location['all'];
			}
...
//var_dump($ip->getLocation("222.83.215.21"));
//var_dump($ip->getLocation("172.106.193.206"));
//exit();
